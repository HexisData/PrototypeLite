...
(function (Innovasys) {
    ...
    (function (Content) {
        var Features;
        (function (Features) {
            var DxDatabaseDocumentFeatureFactory = (function () {
                function DxDatabaseDocumentFeatureFactory() {
                }
                DxDatabaseDocumentFeatureFactory.prototype.createInstance = function (documentInstance) {
                    // Always enabled
                    return new DxDatabaseDocumentFeature(documentInstance);
                };
                return DxDatabaseDocumentFeatureFactory;
            }());
            Features.DxDatabaseDocumentFeatureFactory = DxDatabaseDocumentFeatureFactory;
            var DxDatabaseDocumentFeature = (function (_super) {
                __extends(DxDatabaseDocumentFeature, _super);
                function DxDatabaseDocumentFeature(documentInstance) {
                    _super.call(this, documentInstance);
                }
                DxDatabaseDocumentFeature.prototype.getName = function () {
                    return "dx-db";
                };
                DxDatabaseDocumentFeature.prototype.populateResponsiveConfiguration = function (configuration) {
                    ...
                    if (configuration.profileName == "mobile" || configuration.profileName == "tablet") {
                        switch (configuration.profileName) {
                            case "tablet":
                                break;
                            case "mobile":
                                configuration.clickTargets.push(new Content.ResponsiveClickTarget(".i-relationship-column-list th a,"
                                    + "#i-overview-section-content a", Content.ResponsiveClickTargetKind.inline));
                                configuration.tablesToPivot.push(new Content.ResponsiveTable("#i-columns-section-content table.i-column-list", function (originalTable, pivotDiv) {
                                    pivotDiv.appendTo('#i-columns-section-content');
                                    var primaryKeyRow = originalTable.find('td:first-child img').first().closest('tr');
                                    var primaryKeyColumnName = primaryKeyRow.children('td.i-link').text();
                                    pivotDiv.find('span.btn').each(function (index, element) {
                ...
                return DxDatabaseDocumentFeature;
            }(Features.DxBaseDocumentFeature));
            Features.DxDatabaseDocumentFeature = DxDatabaseDocumentFeature;
        })(Features = Content.Features || (Content.Features = {}));
    })(Content = Innovasys.Content || (Innovasys.Content = {}));
})(Innovasys || (Innovasys = {}));
Innovasys.Content.DocumentFeatureConfiguration.registerDocumentFeatureFactory(new Innovasys.Content.Features.DxDatabaseDocumentFeatureFactory());

//# sourceMappingURL=innovasys.dx.db.js.map
