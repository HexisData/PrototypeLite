...
FROM
	hq_Recon.t_Break B
	INNER JOIN hq_Recon.t_Map M ON M.MapId = B.MapId
	...
	CROSS APPLY hq_Core.tvf_ComposeDatatype(LC.DATA_TYPE, LC.CHARACTER_MAXIMUM_LENGTH, LC.NUMERIC_PRECISION, LC.NUMERIC_SCALE) LD
	...
	CROSS APPLY hq_Core.tvf_ComposeDatatype(RC.DATA_TYPE, RC.CHARACTER_MAXIMUM_LENGTH, RC.NUMERIC_PRECISION, RC.NUMERIC_SCALE) RD
