CREATE TABLE [dbo].[t_Recon_TestLeft]
(
...
GO
ALTER TABLE [dbo].[t_Recon_TestLeft] ADD CONSTRAINT [PK_t_Recon_TestLeft] PRIMARY KEY CLUSTERED  ([LeftKey1], [LeftKey2]) ON [PRIMARY]
GO
