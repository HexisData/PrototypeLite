CREATE TABLE [dbo].[t_Recon_TestRight]
(
...
GO
ALTER TABLE [dbo].[t_Recon_TestRight] ADD CONSTRAINT [PK_t_Recon_TestRight] PRIMARY KEY CLUSTERED  ([RightKey1], [RightKey2]) ON [PRIMARY]
GO
